...
let amazon-bedrock = AmazonBedrock::ai21_jamba_1_5_large_v1_0();
```
...
* AmazonBedrock's default base URL (https://bedrock-runtime.us-east-1.amazonaws.com/openai/v1/)
...
```rust
let amazon-bedrock = AmazonBedrock::<Ai21Jamba15LargeV10>::builder()
...
let amazon-bedrock = AmazonBedrock::model_name("ai21.jamba-1-5-large-v1:0");
```
...
For compile-time safety, use the typed methods like `AmazonBedrock::ai21_jamba_1_5_large_v1_0()`.
</Callout>
