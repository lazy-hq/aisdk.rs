...
* XAI's default base URL (https://api.x.ai/v1/)
...
let xai = XAI::<DynamicModel>::builder()
	.model_name("grok-2")
	.api_key("your-api-key")
	.base_url("https://api.x.ai/v1/")
	.path("https://full-url.example/v1/chat/completions")
...
For compile-time safety, use the typed methods like `XAI::grok_2()`.
</Callout>
