...
- `schema<T: JsonSchema>()`: Configures model for [structured output](/docs/concepts/structured-output).
- **Lifecycle Hooks** : Lifecycle hooks and step-level introspection See [Agents](/docs/concepts/agents#lifecycle-hooks).
