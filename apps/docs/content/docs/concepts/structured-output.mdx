...
AISDK utilizes the [**Capability System**](/docs/concepts/generating-text#the-capability-system) to ensure that **structured output** is only requested from models that officially support it. This check happens at **compile time**, preventing runtime errors and ensuring your code is robust.
