...
When you provide tools to a [LanguageModelRequest](/docs/concepts/generating-text), AISDK automatically manages the **Agentic Loop**. 
...
- See how [Capabilities](/docs/concepts/generating-text#capability-system) protect your agent logic.
