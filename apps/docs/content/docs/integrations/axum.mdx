...
```bash
cargo add axum tower-http --features tower-http/cors
```
...
2. **Processing**: AISDK.rs processes the request with [`LanguageModelRequest`](/docs/concepts/generating-text) Streaming API
