...
you can find more info about generating text [here](/docs/concepts/generating-text#generate_text).
...
You can find more info about streaming text [here](/docs/concepts/generating-text#stream_text).
...
* Take a deeper look at [`LanguageModelRequest`](/docs/concepts/generating-text)
